...
(function() {
  Trestle.ready(function() {
    ...
    return $('input[type="time"][data-picker="true"]').flatpickr({
      enableTime: true,
      noCalendar: true,
      allowInput: true,
      altInput: true,
...
(function() {
  Trestle.ready(function() {
    ...
    return $('[data-behavior~="gallery"]').magnificPopup({
      delegate: 'a',
      type: 'image',
      closeOnContentClick: false,
      closeBtnInside: false,
...
(function() {
  Trestle.ready(function() {
    ...
    sidebar.find('.navbar-toggle').on('click', function(e) {
      ...
      return $('body').toggleClass('mobile-nav-expanded');
    });
    ...
    $('.app-wrapper').on('click touchstart', function(e) {
      var clickInHeader, clickInSidebar, navExpanded;
      ...
      if (navExpanded && !clickInHeader && !clickInSidebar) {
        ...
        e.preventDefault();
        $('.app-wrapper').addClass('animate');
        return $('body').removeClass('mobile-nav-expanded');
      }
    });
    return sidebar.find('.toggle-sidebar').on('click', function(e) {
      e.preventDefault();
      if (sidebar.hasClass('expanded') || sidebar.hasClass('collapsed')) {
        sidebar.removeClass('expanded').removeClass('collapsed');
        return document.cookie = "trestle:sidebar=; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT";
      } else if ($(document).width() >= 1200) {
        sidebar.addClass('collapsed');
        return document.cookie = "trestle:sidebar=collapsed; path=/";
      } else if ($(document).width() >= 768) {
        sidebar.addClass('expanded');
        return document.cookie = "trestle:sidebar=expanded; path=/";
      }
    });
  });
...
(function() {
  Trestle.ready(function() {
    ...
    if (location.hash.substr(0, 2) === "#!") {
      return $("a[data-toggle='tab'][href='#" + (location.hash.substr(2)) + "']").tab("show");
    }
  });
